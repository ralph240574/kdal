...
package com.weather.sample.ui.view
...
import com.weather.sample.ui.view.SlidingTabLayout.TabColorizer
 ...
 *
 *
 * To use the component, simply add it to your view hierarchy. Then in your [android.app.Activity] or [android.support.v4.app.Fragment] call [ ][.setViewPager] providing it the ViewPager this layout is being used for.
 *
 *
 * The colors can be customized in two ways. The first and simplest is to provide an array of colors via [.setSelectedIndicatorColors] and [ ][.setDividerColors]. The alternative is via the [TabColorizer] interface which provides you complete control over which color is used for any
 * individual position.
 *
 *
 * The views used as tabs can be customized by calling [.setCustomTabView], providing the layout ID of your custom layout.
 */
class SlidingTabLayout @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null, defStyle: Int = 0) : HorizontalScrollView(context, attrs, defStyle) {
     ...
     *
     *
     * If you only require simple custmisation then you can use [.setSelectedIndicatorColors] and [.setDividerColors] to achieve
     * similar effects.
     */
    ...
    /**
     * Set the [ViewPager.OnPageChangeListener]. When using [SlidingTabLayout] you are required to set any [ViewPager.OnPageChangeListener]
    ...
    /**
     * Create a default view to be used for tabs. This is called if a custom tab view is not set via [.setCustomTabView].
     */
    ...
    /**
     * Allows complete control over the colors drawn in the tab layout. Set with [.setCustomTabColorizer].
     */
