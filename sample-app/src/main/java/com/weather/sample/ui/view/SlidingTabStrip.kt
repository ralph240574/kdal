...
internal class SlidingTabStrip @JvmOverloads constructor(context: Context, attrs: AttributeSet? = null) : LinearLayout(context, attrs) {
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        if (childCount > 0) {
            ...
            if (mSelectionOffset > 0f && mSelectedPosition < getChildCount() - 1) {
                ...
                if (color != nextColor) {
                    color = blendColors(nextColor, color ?: 0, mSelectionOffset)
                }
            ...
            mSelectedIndicatorPaint.color = color ?: 0
        ...
        for (i in 0 until childCount - 1) {
            ...
            mDividerPaint.color = tabColorizer?.getDividerColor(i) ?: 0
    ...
    companion object {
         ...
         *
         * @param ratio of which to blend. 1.0 will return `color1`, 0.5 will give an even blend, 0.0 will return `color2`.
         */
